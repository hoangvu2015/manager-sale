...
<script>
  ...
  const mimes = {
    ...
    data2blob = function(data, mime) {
      ...
      // canvas.toDataURL default image/png
      return new Blob([ia], {
        type: mime
      });
    };
    ...
    data() {
      let that = this,
        ...
        langBag = {
          ...
          vi: {
            hint: 'Click, hoặc kéo thả file hình ảnh vào đây',
            loading: 'Uploading...',
            noSupported: 'Trình duyệt của bạn hiện không hỗ trợ, vui lòng dùng trình duyệt IE10+ trở lên hoặc trình duyệt khác',
            success: 'Đăng tải thành công',
            fail: 'Đăng tải thất bại',
            preview: 'Xem trước',
            btn: {
              off: 'Hủy',
              close: 'Đóng',
            ...
            error: {
              onlyImg: 'Vui lòng chỉ tải file hình ảnh',
              outOfSize: 'Hình ảnh vượt quá giới hạn kích thước: ',
              lowestPx: 'Độ phân giải tối thiểu: '
            }
          }
        },
      ...
      return {
        ...
        loading: 0, // 1-uploading 2-success 3-fail
        progress: 0,
