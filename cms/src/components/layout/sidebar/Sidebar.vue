    ...
    <aside class="sidebar">
        <vuestic-scrollbar>
            <ul class="sidebar-menu">
                <li v-for="(item, index) in menuItems" v-if="!item.hidden" :key="index">
                    ...
                    <expanding>
                        <ul class="sidebar-submenu" v-show="item.meta.expanded">
                            <li v-for="(childItem, index) in item.children" :key="index" v-if="!childItem.hidden">
                                <router-link :to="childItem.path" class="sidebar-link sidebar-submenu-link"> {{childItem.meta.title}}</router-link>
                            </li>
                        </ul>
                    </expanding>
                </li>
...
<script>
    ...
    import VuesticScrollbar from 'components/vuestic-components/vuestic-scrollbar/VuesticScrollbar'
